<template>
  <header id="header">
    <div class="d-flex flex-column">
      <div class="perfil">
        <img class="img-fluid rounded-circle" src="../assets/logo-joystick.jpeg" alt="">
        <h1 class="text-light"> Feriani Store 🎮 </h1>
...
<style scoped>
/* Adicione qualquer estilo específico ao Header.vue aqui */
</style>
